<?php 
    ...
    $rooms_number = $planData['rooms_number'];
    if(empty($rooms_number)){
        $rooms_number = "Unknown";
    }
...
?>
<div class="plan lodging_plan mb-4" style="margin-bottom: 60px !important;">
    ...
    <div class="info ms-5 card p-3">
        <div class="d-flex align-items-cener justify-content-between">
            ...
            <div class="d-flex">
                <?php if($isAdmin){?>
                <i class="bi bi-three-dots-vertical pointer" style="font-size: 25px;" id="dropdownMenuButton<?=$planData['id']?>" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer;"></i>
                <?php } ?>
              
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton<?=$planData['id']?>">
        ...
        <div class="col-12 col-xl-12 col-lg-12 col-md-12">
            <div class="d-flex align-items-cener justify-content-between mt-2">
                <h4 style="margin: 0 !important;">Check in</h4>
                <div class="d-flex">
                    <h4 style="margin: 0 !important;"><?=empty($endTime)&&empty($endDate)?'':'Check out'?></h4>
                </div>
            </div>
            <div class="d-flex align-items-cener justify-content-between ">
                <div>
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <div>
                    <ul class="userLists unstyled-list p-0 m-0">
                        ...
                        <li><i class="fa-solid fa-user"></i> <?=$contact?></li>
                        <li>Number of rooms: <?=$rooms_number?></li>
                    </ul>
                </div>
                <div class="d-flex">
                    <ul class="userLists unstyled-list p-0 m-0" style="text-align: right;">
                        ...
                        ?>
                                <li>Room details: <?=$room_description?></li>
                        <?php
                            }else{
                                echo'<li></li>';
                            }
                        ...
                        <?php 
                            if(floatval($total_mileage_used)>0){
                        ?>
                                <li>Mileage redeemed: <?=$total_mileage_used?></li>
                        <?php
                            }else{
                                echo'<li></li>';
                            }
