...
?>
<div class="plan restaurant_plan mb-4" style="margin-bottom: 60px !important;">
    ...
    <div class="info ms-5 card p-3">
        ...
        <div class="col-12 col-xl-12 col-lg-12 col-md-12">
            <div class="d-flex align-items-cener justify-content-between mt-2">
                <h4 style="margin: 0 !important;">Reservation date</h4>
                <div class="d-flex">
            ...
            <div class="d-flex align-items-cener justify-content-between ">
                ...
                <div class="d-flex">
                    <div style="text-align: right;">
                        <p style="margin: 0 !important; font-size: 18px;"></p>
