...
<div class="plan carRenting_plan mb-4" style="margin-bottom: 60px !important;">
    ...
    <div class="info ms-5 card p-3">
        <div class="d-flex align-items-cener justify-content-between">
            ...
            <div class="d-flex">
                <?php if($isAdmin){?>
                <i class="bi bi-three-dots-vertical pointer" id="dropdownMenuButton" style="font-size: 25px;" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer;"></i>
                <?php } ?>
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <div class="d-flex">
                    <ul class="userLists unstyled-list p-0 m-0" style="text-align: right;">
                        ...
                        ?>
                                <li>Car details: <?=$car_description?></li>
                        <?php
                            }else{
                                echo'<li></li>';
                            }
