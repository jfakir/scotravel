...
<div class="col-12 plan_detail_container" id="hotel_detail_container">
    <div class="d-flex justify-content-between">
        <div class="d-flex">
            <h3 class="fw-bold m-0">Activity</h3>
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="<?php echo base_url() . 'activties/edit?planID=1' ?>"><button class="btn btn-primary ms-2"><i class="bi bi-pen-fill"></i> Edit</button></a>
            <a><button class="btn btn-danger ms-2"><i class="bi bi-trash3-fill"></i> Delete</button></a>
        </div>
    </div>
    <p class="m-0">Activity | Confirmation <span class="fw-bold">C12345</span></p>
    ...
    <div class="card p-3 w-100">
        ...
        <div class="d-flex">
            <div class="primary_details w-100">
                <div class="d-flex">
                    <div class="me-3">
                        <p class="m-0">Starting Fri, Nov 1, 2024</p>
                        <h4>12:00 PM</h4>
                    </div>
                    <div>
                        <p class="m-0">Ending Sat, Nov 2, 2024</p>
                        <h4>12:00 PM</h4>
                    </div>
                </div>
                <ul class="list-unstyled">
                    ...
                    <li><a href=""><i class="bi bi-envelope-fill"></i> contact@activity.com</a></li>
                    <li><a href=""><i class="bi bi-globe"></i> www.google.com</a></li>
                    <li><a href=""><i class="bi bi-clock-fill"></i> Duration : 1 day, 7 hours</a></li>
                </ul>
            </div>
        </div>
    </div>
