...
<div class="col-12 plan_detail_container" id="carrenting_detail_container">
    <div class="d-flex justify-content-between">
        <div class="d-flex">
            <h3 class="fw-bold m-0">Car Renting Agency</h3>
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="<?php echo base_url() . 'carrentings/edit?planID=1' ?>"><button class="btn btn-primary ms-2"><i class="bi bi-pen-fill"></i> Edit</button></a>
            <a><button class="btn btn-danger ms-2"><i class="bi bi-trash3-fill"></i> Delete</button></a>
        </div>
    </div>
    <p class="m-0">Car Renting | Confirmation <span class="fw-bold">C12345</span></p>
        ...
        <div class="d-flex">
            <div class="primary_details w-75">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href=""><i class="bi bi-clock-fill"></i> Duration 1d, 7hours</a></li>
                </ul>
            </div>
            <div class="secondary_details w-25">
                <h5 class="fw-bold">Secondary Details</h5>
                <ul class="list-unstyled">
                    <li class="fw-bold">Car Type : <span class="fw-light">EV</span></li>
