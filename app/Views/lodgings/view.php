...
<div class="col-12 plan_detail_container" id="hotel_detail_container">
    <div class="d-flex justify-content-between">
        <div class="d-flex">
            <h3 class="fw-bold m-0">Le Grand Hotel</h3>
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="<?php echo base_url() . 'lodging/edit?planID=1' ?>"><button class="btn btn-primary ms-2"><i class="bi bi-pen-fill"></i> Edit</button></a>
            <a><button class="btn btn-danger ms-2"><i class="bi bi-trash3-fill"></i> Delete</button></a>
        </div>
    </div>
    <p class="m-0">Lodging | Confirmation <span class="fw-bold">C12345</span></p>
    ...
    <div class="card p-3 w-100">
        ...
        <div class="d-flex">
            <div class="primary_details w-75">
                <div class="d-flex">
                    <div class="me-3">
                        <p class="m-0">Check in Fri, Nov 1, 2024</p>
                        <h4>12:00 PM</h4>
                    </div>
                    <div>
                        <p class="m-0">Check Out Sat, Nov 2, 2024</p>
                        <h4>12:00 PM</h4>
                    </div>
                </div>
                <ul class="list-unstyled">
                    <li class="location" title="Google Map"><i class="bi bi-geo-alt-fill"></i> Address 123, Street 123</li>
                    <li><a href=""><i class="bi bi-telephone-fill"></i> +9611122336644</a></li>
                    <li><a href=""><i class="bi bi-envelope-fill"></i> contact@lodging.com</a></li>
                    <li><a href=""><i class="bi bi-globe"></i> www.google.com</a></li>
                    <li title="Supplier name"><i class="bi bi-person-circle"></i> Mr. John Doe</li>
                </ul>
            </div>
            <div class="secondary_details w-25">
                <h5 class="fw-bold">Secondary Details</h5>
                <ul class="list-unstyled">
                    <li class="fw-bold">Number of rooms : <span class="fw-light">1</span></li>
                    <li class="fw-bold">Rooms description : <span class="fw-light">Amazing</span></li>
                </ul>
            </div>
        </div>
    </div>
