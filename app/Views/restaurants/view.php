...
<div class="col-12 plan_detail_container" id="hotel_detail_container">
    <div class="d-flex justify-content-between">
        <div class="d-flex">
            <h3 class="fw-bold m-0">Saniour Sea View</h3>
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="<?php echo base_url() . 'lodgings/edit' ?>"><button class="btn btn-primary ms-2"><i class="bi bi-pen-fill"></i> Edit</button></a>
    ...
    <div class="card p-3 w-100">
        ...
        <div class="d-flex">
            <div class="primary_details w-75">
                <div class="d-flex">
                    <div class="me-3">
                        <p class="m-0">Reservation Fri, Nov 1, 2024</p>
                        <h4>12:00 PM</h4>
                    </div>
                </div>
            ...
            <div class="secondary_details w-25">
                ...
                <ul class="list-unstyled">
                    <li class="fw-bold">Cuisine : <span class="fw-light">Lebanese</span></li>
                    <li class="fw-bold">Dress Code : <span class="fw-light">Casual</span></li>
                </ul>
            </div>
        </div>
    </div>
